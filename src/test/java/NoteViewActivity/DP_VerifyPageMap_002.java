...
public class DP_VerifyPageMap_002 extends AppiumDriverBase {
	...
	public void End_To_End_Test_Sample() throws Exception {
		...
		assertEquals("사진 페이지", driver.findElement(By.xpath("//android.widget.TextView[contains(@resource-id, 'com.fasoo.digitalpage:id/txtContent')]")).getText());
