...
public class DP_VerifyPageMap_003 extends AppiumDriverBase {
	...
	public void End_To_End_Test_Sample() throws Exception {
		...
		// 자동 음성 페이지 작성 로직 (AutoVoicePageClass.java)
		...
		Assert.assertTrue(driver.findElement(By.xpath("//*[@class='android.widget.ImageView'][@index='0']")).isEnabled());
		assertEquals("00:00", driver.findElement(By.xpath("//android.widget.TextView[contains(@resource-id, 'com.fasoo.digitalpage:id/txtContent')]")).getText());
