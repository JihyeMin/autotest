...
public class DP_AppInfoMenu_002 extends AppiumDriverBase {
	...
	public void End_To_End_Test_Sample() throws Exception {
		...
		// 이용 약관 영역 탭
		AndroidElement ele = driver.findElement(By.xpath("//*[@class='android.widget.TextView'][@instance='14']"));
		...
		// 이용약관 탑바 확인
		assertEquals("이용약관", driver.findElement(By.id("com.fasoo.digitalpage:id/txtToolbarTitle")).getText());
		Thread.sleep(1000);
