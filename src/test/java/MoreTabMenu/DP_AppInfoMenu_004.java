...
public class DP_AppInfoMenu_004 extends AppiumDriverBase {
	...
	public void End_To_End_Test_Sample() throws Exception {
		...
		// Open Source License 영역 탭
		AndroidElement ele = driver.findElement(By.xpath("//*[@class='android.widget.TextView'][@instance='16']"));
		...
		// Open Source License 탑바 확인
		assertEquals("Open Source License", driver.findElement(By.id("com.fasoo.digitalpage:id/txtToolbarTitle")).getText());
		Thread.sleep(1000);
