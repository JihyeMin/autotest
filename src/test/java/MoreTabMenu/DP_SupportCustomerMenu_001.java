...
public class DP_SupportCustomerMenu_001 extends AppiumDriverBase {
	...
	public void End_To_End_Test_Sample() throws Exception {
		...
		// 공지사항 영역을 탭한다.
		AndroidElement ele = driver.findElement(By.xpath("//*[@class='android.widget.TextView'][@instance='9']"));
		...
		// 현재 액티비티 확인
		assertEquals("공지사항", driver.findElement(By.id("com.fasoo.digitalpage:id/tbarTitle")).getText());
		Thread.sleep(3000);
