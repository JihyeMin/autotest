...
public class DP_PrimeService_002 extends AppiumDriverBase {
	...
	public void End_To_End_Test_Sample() throws Exception {
		...
		//매월 버튼 탭
		driver.findElement(By.id("com.fasoo.digitalpage:id/btnBuyMonthly")).click();
		Thread.sleep(3000);
		
		Assert.assertTrue(driver.findElement(By.id("android:id/parentPanel")).isDisplayed());
		...
		Assert.assertTrue(text1.contains("프라임서비스 - 매월 "));
		Thread.sleep(3000);
