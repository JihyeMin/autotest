...
public class DP_LoginActivity_009 extends AppiumDriverBase  {
	...
	public void sampleTest() throws Exception {
		...
		// Kakao App 설치 상태 - 'Kakao' 버튼 클릭
		driver.findElement(By.id("com.fasoo.digitalpage:id/btnLoginKakao")).click();
		Thread.sleep(1000);
		
		// 카카오톡으로 간편 로그인 클릭
		driver.findElement(By.xpath("//*[@class='android.widget.LinearLayout'][@instance='1']")).click();
